    ...
    class BrokenTool
    {
        ...
        public async static void Manage(CommandArgs args)
        {
            ...
            void Help()
            {
                ...
                {
                    "/igen b <id>，清除 指定方块",
                    "/igen b block，清除 所有方块",
                    "/igen b all，清除 所有",
                    "/igen b wall，清除 所有墙体",

                    "/igen b liquid，清除 所有液体",
                    "/igen b wire，清除 所有电线",

                    "/igen b water，清除 水",
                    "/igen b honey，清除 蜂蜜",
                    "/igen b lava，清除 岩浆",
                    "/igen b shimmer，清除 微光",

                    "/igen b redwire，清除 红电线",
                    "/igen b bluewire，清除 蓝电线",
                    "/igen b greenwire，清除 绿电线",
                    "/igen b yellowwire，清除 黄电线",
                };
